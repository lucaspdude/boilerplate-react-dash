...
import { createUsuariosRequest } from '~/store/modules/usuarios/actions'
...
export default function CadastroUsuarios() {
  ...
  function handleSubmit(data) {
    dispatch(createUsuariosRequest(data))
  }
...
<button type="submit" className="btn btn-black justify-self-end">Cadastrar</button>
</div>
